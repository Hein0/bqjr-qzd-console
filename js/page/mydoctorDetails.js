...
//      detailUtil.getHospital();
        if (path.indexOf('?') >= 0) {
            ...
            if(status =="10" || status =="11"){
            	if (id) {
	            	detailUtil.id = id;
	                detailUtil.getDoctorInfo(id,true);
	            }
            }else{
            	if (his_id) {
    ...
    'renderDoctorDetails': function (data) {
        ...
        <tr>\
            ...
            <td>\
                <img src="'+ imgPath + data.zige + '" class="img-responsive" width="50%" alt="医师资格证书首页与详细信息页">\
            </td>\
        </tr>\
        <tr>\
            <th>医师执业证书首页与详细信息页</th>\
            <td>\
                <img src="'+ imgPath + data.congye + '" class="img-responsive" width="50%" alt="医师执业证书首页与详细信息页">\
            </td>\
        </tr>\
        <tr>\
            <th>医疗美容主诊医生资格证书详细信息页</th>\
            <td>'+ (data.zhuzhen ? '<img src="'+ imgPath + data.zhuzhen + '" class="img-responsive" width="50%" alt="医疗美容主诊医生资格证书详细信息页">' : "") + ' </td>\
        </tr>';
