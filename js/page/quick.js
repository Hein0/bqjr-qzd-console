...
var pageUtil = {
    ...
    'getSearchValue': function () {
        ...
        data.cat = $wrap.find("#cat option:selected").val(); 
        data.type = 4;
        return data;
    },
...
$(function () {
    ...
    $('#resetBtn').on('click', function () {
        ...
        $wrap.find("#cat").val("").trigger("change");
        ...
        var winLay = layer.open({
            ...
            success: function (layero, index) {
                ...
                $(".addBtns").on("click", function () {
                    ...
                    if ($("#cats option:selected").val() == "") {
                        layer.msg("项目分类!");
                        return;
                    }else{
                    	data.cat = $("#cats option:selected").val();
                    }
